...
public class IdRelacionamento implements Serializable {
	...
	public String toString() {
		return "IdRelacionamento [idCampaing=" + idCampaing + ", idSoccerTeam=" + idSoccerTeam + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IdRelacionamento other = (IdRelacionamento) obj;
		if (idCampaing == null) {
